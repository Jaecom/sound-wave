		...
		<>
			...
			<SafeAreaView style={styles.container}>
				<View style={styles.searchContainer}>
					...
					<TouchableOpacity style={styles.cancelTextContainer} onPress={router.back}>
					...
					<View style={styles.content}>
						<View>
							...
							<View style={webtoonStyles.container}>
								{text.length > 2 && (
									<>
										<Text style={webtoonStyles.header}>웹툰</Text>
										<View style={webtoonStyles.resultListContainer}>
											{webtoonResult.map((webtoon) => (
												<Link href={`/webtoons/${webtoon.id}`} key={webtoon.id}>
